...
/**
 * method to set up a lease for a company
 * if there is available car, then lease next available car to the customer
 * otherwise tell the customer no cars available
 ...
 * this method prints out all leased cars, and takes a number in,
 * according to the number to return a car in the lease list.
 * @param the rental company
 */
...
/**
 * main method, which sets up a company with name and cars first,
 * then prints out information and responses accordingly to users input
 * @param args
 */
